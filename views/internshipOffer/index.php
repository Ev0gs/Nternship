...
<div class="content-container" id="internship-container">
    ...
    <div class="button-container">
        ...
        <div class="btn-group" role="group">
            <a href="/InternshipOffer" class="btn btn-filter active" id="BestMatchesBtn">All offers</a>
            <a href="/InternshipOffer/MostRecent" class="btn btn-filter" id="MostRecentBtn">Most Recent</a>
        </div>
            ...
            <a href="/InternshipOffer/Read/<?= $InternshipOffer['id_internship_offer'] ?>">
                <div class="card" id="card">
                    ...
                    <div class="card-footer">
                        <div class="btn-group  btn-group-internship" role="group">
